...
Lock Pop Arcade's code, visuals, favicon, timing rules, and interface are original to this repository. Sound FX Board's code, visuals, generated sounds, meme-style effects, and interface are original to this repository. The miss cue, Fahhh button, and `games/soundboard/assets/user-samples/` files use local user-provided assets; verify their licenses before public distribution if needed.
